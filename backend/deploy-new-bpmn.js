...
// Create a new BPMN file with the correct gateway conditions
...
async function deployNewBPMN() {
  console.log('🔧 DEPLOYING NEW BPMN WITH CORRECT GATEWAY CONDITIONS\n');
  
  try {
    // Save the new BPMN to a file
    const newBpmnPath = path.join(__dirname, 'new-policy-management.bpmn');
